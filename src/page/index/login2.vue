    ...
    <div class="drag_div" id="drag_div">
      <div class="one" v-if="broaddisplay == 0">
        <router-link
          ...
          :to="{ path: '/index/mainview', query: { id: 1 } }"
        >
        </router-link>
      ...
      <div class="two" v-if="villagedisplay == 0">
        <router-link
          class="welcome"
          :to="{ path: '/index/villageindex', query: { id: '2-1' } }"
        >
          <span>欢迎进入</span>
        </router-link>
      ...
      <div class="three" v-if="iotdisplay == 0">
        <router-link
          class="three"
          :to="{ path: '/index/Iotview', query: { id: 3 } }"
          style="height: 150px; width: 200px"
        >
        </router-link>
...
export default {
  ...
  methods: {
    logindisplay: function () {
      this.$http.get("http://localhost/api/forePage_col/pagestatus").then(
        function (res) {
