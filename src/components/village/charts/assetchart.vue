...
export default {
  ...
  methods: {
    getcoldata: function () {
      ...
      this.$http
        .get("api/count/g_asset")
        .then(function (res) {
          for (let i = 0; i < res.data.data.length; i++) {
            const adata = {
              value: [
                res.data.data[i].constructionland,
                res.data.data[i].imsland,
                res.data.data[i].businessland,
                res.data.data[i].homestead,
                res.data.data[i].publicland,
                res.data.data[i].twland,
                res.data.data[i].otherland,
              ],
