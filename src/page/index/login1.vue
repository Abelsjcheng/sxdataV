  ...
  <div>
    ...
    <div class="mask">
      <div class="centermain">
        <div class="top1">
          <span
            style="font-size: 25px; position: absolute; left: 21%; top: 30%"
            >{{ ndata.year }}</span
          >
          <span
            style="font-size: 25px; position: absolute; left: 32%; top: 55%"
            >{{ ndata.week }}</span
          >
        </div>
        <div
          ...
          <a class="op_weather_day" style="width: 115px">
            ...
            <div class="op_weather_shishi_info">
              ...
              <span class="op_weather_shishi_data">
                ...
                <i class="op_weather_shishi_sub"
                  >{{ weather.now.weather }}(实时)</i
                >
              </span>
            </div>
